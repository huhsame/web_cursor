...
커서에서 터미널을 열고, **아래 명령어를 직접 타이핑**하세요:
...
> 이미 `my-budget-app` 폴더 안에 있다면 이 명령어는 건너뛰세요!
...
<!-- 스크린샷: Plan 모드 여는 방법 (Composer 아이콘 또는 메뉴) -->

커서에서 **Composer** 또는 **Plan 모드** 버튼을 찾아 클릭합니다.

> 💡 버전에 따라 위치가 다를 수 있습니다.
> 오른쪽 상단이나 사이드바를 확인해보세요.
