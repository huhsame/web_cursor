...
2. **Download** 버튼 클릭
3. 운영체제에 맞는 버전이 자동으로 다운로드됩니다

<!-- 스크린샷: cursor.com 다운로드 페이지 -->
...
처음 실행하면 AI 모델을 선택하는 화면이 나옵니다.

- **Claude** 또는 **GPT-4** 선택 (둘 다 좋습니다)
- 나중에 설정에서 변경 가능
